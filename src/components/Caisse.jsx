...
function Comptabilite() {
    ...
    // const [ prodctPrice, setProductPrice ] = useState(0)
    ...
    const {isLoading, data, isError, refetch : refetchCaisseContent, refetch : refetchCaisse } = useQuery(['get-caisse-content', filterDate], () => window.api.getCaisseContent(filterDate), { refetchOnWindowFocus : false })
    const { data : totalInCaisse, isError : isErrorForTotal, refetch : refetchTotal } = useQuery(['get-total-caisse', filterDate], () => window.api.getCaisseTotal(filterDate), { refetchOnWindowFocus : false})
    ...
    function addNewEntry(data){
        ...
        toast.success('Entrée/Sortie ajoutée', defaultToast)
        ...
        <div className="caisse-contain">
            ...
            { 
                ...
                <ConfirmAction
                    ...
                    modalText="Supprimer entrée/sortie"
            ...
            <div className="caisse-table override-input-color">
                <div className="table-header table-row">
                    ...
                    <div className="table-cell">
                        <div className="table-sub-cell">Entrées</div>

                    </div>

                    <div className="table-cell">
                        <div className="table-sub-cell">Sorties</div>
                    </div>
                ...
                <div className="table-header table-row">
                    ...
                    <div className="table-cell subcell">
                        <div className="table-sub-cell">Libellé entrées</div>
                        <div className="table-sub-cell">Montant</div>

                    </div>

                    <div className="table-cell subcell">
                        <div className="table-sub-cell">Libellé sorties</div>
                        <div className="table-sub-cell">Montant</div>
                    </div>
                ...
                <form onSubmit={handleSubmit(addNewEntry)} className="table-row table-body ignore-line">
                    ...
                    <div className="table-cell">
                        <input className="form-field" type="text" defaultValue={""} {...register('libelle_entree')} placeholder="Libelle entrée" />
                        <input className="form-field" type="number" {...register('entree', {min : 0})} placeholder="Entrée" />   
                    </div>
...

                    {
                        data?.map(row => (
                            <div className="table-row table-body" key={row?.id}>
                                ...
                                <div className="table-cell"> {row?.dateformat} </div>
                                <div className="table-cell">
                                    <div className="table-sub-cell"> {row?.libelle_entree} </div>
